    ...
    <div ref={refContainer} className="bg-black text-white">
      <div className="min-h-screen max-w-5xl mx-auto px-10 lg:px-20 py-24 md:py-28 lg:py-36 flex flex-col justify-center items-center text-4xl md:text-6xl lg:text-7xl tracking-tight font-semibold">
        <div className="leading-[1.15]">
          ...
          >
            Out team has build and scaled SaaS apps with React, Node.js,
            Express, TypeScript, Next.js, Nestjs, SQL, MongoDB.
          </span>
          <span
          ...
          >
            We&apos;re a software agency that has helped build software for
            clients that have done $100K+ in ARR 6 months within launch
          </span>
        </div>
      </div>
    </div>
